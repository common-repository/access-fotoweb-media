...
if ( isset( $_SESSION['access_token'] ) ) {
	$_SESSION['access_token'] = filter_var( $_SESSION['access_token'], FILTER_SANITIZE_SPECIAL_CHARS );
	$access_token             = $_SESSION['access_token'];
}
if ( isset( $_SESSION['client_id'] ) ) {
	$_SESSION['client_id'] = filter_var( $_SESSION['client_id'], FILTER_SANITIZE_SPECIAL_CHARS );
	$client_id             = $_SESSION['client_id'];
}
if ( isset( $_SESSION['client_secret'] ) ) {
	$_SESSION['client_secret'] = filter_var( $_SESSION['client_secret'], FILTER_SANITIZE_SPECIAL_CHARS );
...
if ( isset( $_GET['code'] ) ) {
	$_GET['code']       = filter_var( $_GET['code'], FILTER_SANITIZE_SPECIAL_CHARS );
...
if ( isset( $_GET['state'] ) ) {
	$_GET['state'] = filter_var( $_GET['state'], FILTER_SANITIZE_SPECIAL_CHARS );
	$state         = $_GET['state'];
}
